...
export const getFirst = (findFnc) => (selector) => {
...
export const getLast = (findFnc) => (selector) => {
    const found = findFnc(selector);
 ...
 */
export const getAt = (findFnc, index) => (selector) => {
    const found = findFnc(selector);
    if (found === null) {
        return null;
    }
 ...
 */
export const take = (findFnc, count) => (selector) => {
    const found = findFnc(selector);
...
export const takeLast = (findFnc, count) => (selector) => {
    const found = findFnc(selector);
    if (found === null || count < 1 || found.length < count) {
        return null;
    }
...
export const filter = (findFnc, predicate) => (selector) => {
    const found = findFnc(selector);
    if (found === null) {
        return null;
    }
